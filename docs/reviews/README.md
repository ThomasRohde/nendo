...
| [custom-views.md](../contracts/custom-views.md) | Phase 3 | Definition authoring, package pin, reopen and preservation when exposed by the installed vocabulary. Runtime journeys remain Not run until desktop integration ships; see Custom-view rollout status. |
