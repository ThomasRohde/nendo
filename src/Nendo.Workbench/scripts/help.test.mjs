...
const expectedResources = ['nendo://application/describe', 'nendo://application/entities', 'nendo://application/entity/{entityId}/export{?cursor,limit}', 'nendo://application/entity/{entityId}/records{?cursor,limit}', 'nendo://application/entity/{entityId}/schema', 'nendo://application/examples', 'nendo://application/extension/{packageId}/file{?path,offset,length}', 'nendo://application/extensions', 'nendo://application/health', 'nendo://application/history{?cursor,limit}', 'nendo://application/manifest', 'nendo://application/proposals', 'nendo://application/revision/{revisionId}/operations{?cursor,limit}', 'nendo://application/surfaces', 'nendo://application/vocabulary', 'nendo://host/instances'];
